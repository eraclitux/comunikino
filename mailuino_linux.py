...
# -*- coding: utf-8 -*-
"""
	Mailuino AKA Comunikino<--->PC bridge, Linux version
	Version: 0.1
...
############ Settings ######################
trustedsender = "CHANGE ME"      # to avoid spam, this is the only address allowed to communicate with Comunikino
...
usbport       = "/dev/ttyUSB0"   # Arduino's tty port
